  ...
  const products = [
    {
      ...
      description:
        "A comprehensive business management platform with advanced analytics, user management, and workflow automation.",
      features: [
    ...
    },
    {
      ...
      description:
        "A powerful customer relationship management mobile app with offline capabilities and AI-powered insights.",
      features: [
    ...
    },
    {
      ...
      description:
        "An intelligent inventory management system with predictive analytics and automated reordering capabilities.",
      features: [
...
function ProductCategoriesSection() {
  const categories = [
    ...
    },
    {
      ...
      title: "E-commerce",
      count: "10+ Products",
      description: "Complete e-commerce solutions and marketplaces",
      color: "#F59E0B",
    },
    {
      icon: Database,
